 ...
 * RestClient
 *
 * This is the client. You can use this to access any REST api on the web.
 * We are using it in example.php to use your own API.
 * So basically you won't have to change anything here.
 *
