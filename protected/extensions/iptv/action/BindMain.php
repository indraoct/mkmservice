...
class BindMain{
    ...
    public function __construct($UserID) {
        ...
        Yii::import('application.extensions.iptv.abstract.Bind.*');
    ...
    public function BindAction(){
        ...
        try{
            ...
            $this->_client->setOperationTimeout(360);
                ...
                $request = new reqBindSTB();
                $request->UserID = $this->_UserID;

                $request1 = new BindSTB();
                $request1->reqBindSTB = $request;


                $this->_data = $this->_client->BindSTB($request1);
                
                $this->__logapi("bind",$this->_UserID,$this->_client->__getLastRequest(),$this->_client->__getLastResponse(),$req_date,date("Y-m-d H:i:s"));
