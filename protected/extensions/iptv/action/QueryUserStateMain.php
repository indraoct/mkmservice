...
class QueryUserStateMain{
    ...
    public function __construct($UserID) {
        ...
        Yii::import('application.extensions.iptv.abstract.QueryUserState.*');
    ...
    public function QueryUserStateAction(){
        ...
        try{
            ...
            $request = new reqQueryUserState();
            $request->UserID = $this->_UserID;
            
            $request1 = new QueryUserState();
            $request1->reqQueryUserState = $request;
            
         
            $this->_data = $this->_client->QueryUserState($request1);
           
            $this->__logapi("queryuserstate",$this->_UserID,$this->_client->__getLastRequest(),$this->_client->__getLastResponse(),$req_date,date("Y-m-d H:i:s"));
             ...
             $this->__logapi("queryuserstate",$this->_UserID,$this->_client->__getLastRequest(),$e->getMessage(),$req_date,date("Y-m-d H:i:s"));
