...
class UnsubscriptionMain{
    ...
    public function __construct($UserID) {
        ...
        Yii::import('application.extensions.iptv.abstract.Unsubscription.*');
    ...
    public function UnsubscriptionAction(){
        ...
        try{
            ...
            $request = new reqUnsubscription();
            $request->UserID = $this->_UserID;

            $request1 = new Unsubscription();
            $request1->reqUnsubscription = $request;


            $this->_data = $this->_client->Unsubscription($request1);      

            $this->__logapi("unsubscription",$this->_UserID,$this->_client->__getLastRequest(),$this->_client->__getLastResponse(),$req_date,date("Y-m-d H:i:s"));
            ...
            return CJSON::encode(array("Result"=> $this->_data->Result,
             ...
             $this->__logapi("unsubscription",$this->_UserID,$this->_client->__getLastRequest(),$e->getMessage(),$req_date,date("Y-m-d H:i:s"));
