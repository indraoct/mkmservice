...
class ReactivationMain{
    ...
    public function __construct($UserID) {
        ...
        Yii::import('application.extensions.iptv.abstract.Reactivation.*');
    ...
    public function ReactivationAction(){
        ...
        try{
            ...
            $request = new reqResumeuser();
            $request->UserID = $this->_UserID;

            $request1 = new Reactivation();
            $request1->reqResumeuser = $request;


            $this->_data = $this->_client->Reactivation($request1);      

            $this->__logapi("reactivation",$this->_UserID,$this->_client->__getLastRequest(),$this->_client->__getLastResponse(),$req_date,date("Y-m-d H:i:s"));
            ...
            return CJSON::encode(array("Result"=> $this->_data->Result,
             ...
             $this->__logapi("reactivation",$this->_UserID,$this->_client->__getLastRequest(),$e->getMessage(),$req_date,date("Y-m-d H:i:s"));
