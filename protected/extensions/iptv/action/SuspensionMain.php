...
class SuspensionMain{
    ...
    public function __construct($UserID) {
        ...
        Yii::import('application.extensions.iptv.abstract.Suspension.*');
    ...
    public function SuspensionAction(){
        ...
        try{
            ...
            $request = new reqSuspension();
            $request->UserID = $this->_UserID;

            $request1 = new Suspension();
            $request1->reqSuspension = $request;


            $this->_data = $this->_client->Suspension($request1);      

            $this->__logapi("suspension",$this->_UserID,$this->_client->__getLastRequest(),$this->_client->__getLastResponse(),$req_date,date("Y-m-d H:i:s"));
            ...
            return CJSON::encode(array("Result"=> $this->_data->Result,
             ...
             $this->__logapi("suspension",$this->_UserID,$this->_client->__getLastRequest(),$e->getMessage(),$req_date,date("Y-m-d H:i:s"));
