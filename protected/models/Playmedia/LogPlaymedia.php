...
/**
 * This is the model class for table "ott_playmedia_services".
 *
 * The followings are the available columns in table 'ott_playmedia_services':
 * @property string $id
 ...
 */
class LogPlaymedia extends CActiveRecord
{
	/**
	 ...
	 * @return LogPlaymedia the static model class
	 */
