...
/**
 * This is the model class for table "ott_services".
 *
 * The followings are the available columns in table 'ott_services':
 * @property string $id
 ...
 */
class OttServices extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('msg_request', 'length', 'max'=>2000),
			array('msg_response', 'length', 'max'=>15000),
	 ...
	 * @return OttServices the static model class
	 */
