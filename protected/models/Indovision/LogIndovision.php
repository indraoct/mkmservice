...
/**
 * This is the model class for table "indovision_anywhere_services".
 *
 * The followings are the available columns in table 'indovision_anywhere_services':
 * @property integer $id
 ...
 */
class LogIndovision extends CActiveRecord
{
	/**
	...
	{
		return 'indovision_anywhere_services';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('ip_address, mac_address', 'length', 'max'=>100),
			array('log_date, request_time, response_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, servicename, msg_request, msg_response, log_date, request_time, response_time, ip_address, mac_address', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return LogIndovision the static model class
	 */
