...
/**
 * This is the model class for table "moviebay_services".
 *
 * The followings are the available columns in table 'moviebay_services':
 * @property string $id
 ...
 */
class LogMoviebay extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('userid, email, ip_address, mac_address', 'length', 'max'=>100),
			array('msg_request, msg_response', 'length', 'max'=>2000),
			array('log_date, request_time, response_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, servicename, userid, email, msg_request, msg_response, log_date, request_time, response_time, ip_address, mac_address', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return LogMoviebay the static model class
	 */
